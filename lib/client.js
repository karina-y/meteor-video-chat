...
class VideoCallServices {
    ...
    handleStreamUpdates(msg) {
        this.handleStreamCalleeAccept(msg);
        this.handleStreamCalleeRejected(msg);
        this.handleStreamCallFinished(msg);
    }
    /**
